...
def centerRectangleAntiderivative(h0, key):
    
    x = np.arange(a+h0/2, b+h0/2, h0)
    n = (b-a)/h0
    ...
    #Вычисление численного интеграла по формуле центральных прямоугольников
...
if __name__ == "__main__": 
    centerRectangleAntiderivative(h[0], 1)
    centerRectangleAntiderivative(h[1], 1)
    centerRectangleAntiderivative(h[2], 1)
    centerRectangleAntiderivative(h[3], 1)
    centerRectangleAntiderivative(h[4], 1)